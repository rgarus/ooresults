...
@pytest.fixture
def entry_1(
    db: SqliteRepo, event: EventType, class_a: ClassType, competitor_1_id: int
) -> EntryType:
    with db.transaction():
        id = db.add_entry(
            event_id=event.id,
...
@pytest.fixture
def entry_2(
    db: SqliteRepo, event: EventType, class_b: ClassType, competitor_2_id: int
) -> EntryType:
    with db.transaction():
        id = db.add_entry(
            event_id=event.id,
...
@pytest.fixture
def entry_3(
    db: SqliteRepo, event: EventType, class_b: ClassType, competitor_3_id: int
) -> EntryType:
    with db.transaction():
        id = db.add_entry(
            event_id=event.id,
